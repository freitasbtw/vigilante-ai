      ...
      <header className="sticky top-0 z-30 border-b border-border bg-bg-elevated/85 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
          ...
          <nav className="hidden items-center gap-1 text-[15px] font-medium md:flex">
            ...
            <Link href="/equipe" className="rounded-md px-3 py-1.5 text-text-muted transition hover:bg-bg-sunken hover:text-text">
              Equipe
            </Link>
          </nav>
      ...
      <footer className="border-t border-border bg-bg-elevated">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-6 py-8 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-6 text-sm text-text-muted">
            <Link href="/equipe" className="transition hover:text-text">Equipe</Link>
            <a
